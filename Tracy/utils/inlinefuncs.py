...
from Tracy import pbot as app
from Tracy import arq
from Tracy.services.keyboard import Ikb
from Tracy.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from Tracy.services.tasks import _get_tasks_text, all_tasks, rm_task
from Tracy.services.types import InlineQueryResultCachedDocument
from Tracy.modules.info import get_chat_info, get_user_info
from Tracy.modules.music import download_youtube_audio
from Tracy.utils.functions import test_speedtest
from Tracy.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    msg = f"""
**[Tracy Robot ❤️](https://t.me/Tracy):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/Tracy)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
