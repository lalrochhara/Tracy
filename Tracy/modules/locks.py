...
import Tracy.modules.sql.locks_sql as sql
from Tracy.modules.helper_funcs.decorators import Tracycmd, Tracymsg
from Tracy.modules.sql.approve_sql import is_approved
from Tracy import DRAGONS, LOGGER as log, dispatcher
from Tracy.modules.helper_funcs.chat_status import (
    can_delete,
    is_user_admin,
    user_not_admin,
    is_bot_admin,
...
@Tracycmd(command="lock", pass_args=True)
@user_admin
@loggable
@typing_action
...
@Tracycmd(command="unlock", pass_args=True)
@user_admin
@loggable
@typing_action
...
@Tracymsg((Filters.all & Filters.chat_type.groups), group=PERM_GROUP)
@user_not_admin
