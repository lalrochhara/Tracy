...
import Tracy.modules.sql.global_bans_sql as sql
from Tracy.modules.language import gs
from Tracy.modules.sql.users_sql import get_user_com_chats
from Tracy import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from Tracy.modules.helper_funcs.misc import send_to_list
